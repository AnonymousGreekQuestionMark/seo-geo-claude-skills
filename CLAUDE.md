...
This plugin provides **21 skills and 10 commands** for Search Engine Optimization (SEO) and Generative Engine Optimization (GEO). All skills follow one shared contract: trigger, quick start, skill contract, handoff summary, and next best skill. Skills are auto-loaded by context; commands are invoked with `/seo:`.
...
/seo:analyze-company   — Full company analysis (all 20 skills) + HTML report
```
...
**Skill**: [orchestration/company-analysis/SKILL.md](https://github.com/aaron-he-zhu/seo-geo-claude-skills/blob/main/orchestration/company-analysis/SKILL.md)
