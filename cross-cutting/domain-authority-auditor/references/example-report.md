...
**Diagnosis**: Low CITE + unknown CORE-EEAT → Run `/geo:audit-page` on top 5 landing pages to determine whether to prioritize content quality or domain authority first.
...
- For tracking progress: run `/geo:report` with CITE score trends quarterly
```
